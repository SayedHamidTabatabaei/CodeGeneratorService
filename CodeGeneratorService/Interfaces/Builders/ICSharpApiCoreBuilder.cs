...
{
    public class ICSharpApiCoreBuilder : BaseBuilder<CSharpApiCoreParameterModel>
    {
        #region Fields

        private static DateTime CreatedDateTime { get; set; }
        private static CSharpApiCoreParameterModel Parameter { get; set; }

        #endregion

        #region PublicMethods

        public override void Initiate(CSharpApiCoreParameterModel parameter)
        {
            Parameter = parameter;
