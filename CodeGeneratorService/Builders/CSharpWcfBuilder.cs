...
{
    public class CSharpWcfBuilder : BaseBuilder<CSharpWcfParameterModel>, ICSharpWcfBuilder
    {
        #region Fields

        private static DateTime CreatedDateTime { get; set; }
        private static CSharpWcfParameterModel Parameter { get; set; }

        #endregion

        #region PublicMethods

        public override void Initiate(CSharpWcfParameterModel parameter)
        {
            Parameter = parameter;
