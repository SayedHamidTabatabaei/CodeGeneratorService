...
{
    public class SqlProcedureBuilder : BaseBuilder<SqlProcedureParameterModel>, ISqlProcedureBuilder
    {
        #region Fields

        private static DateTime CreatedDateTime { get; set; }
        private static SqlProcedureParameterModel Parameter { get; set; }

        #endregion

        #region PublicMethods

        public override void Initiate(SqlProcedureParameterModel parameter)
        {
            Parameter = parameter;
