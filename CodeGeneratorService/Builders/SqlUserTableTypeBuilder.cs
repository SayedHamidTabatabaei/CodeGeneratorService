...
{
    public class SqlUserTableTypeBuilder:BaseBuilder<SqlUserTableTypeParameterModel>, ISqlUserTableTypeBuilder
    {
        #region Fields

        private static DateTime CreatedDateTime { get; set; }
        private static SqlUserTableTypeParameterModel Parameter { get; set; }

        #endregion

        #region PublicMethods

        public override void Initiate(SqlUserTableTypeParameterModel parameter)
        {
            Parameter = parameter;
