...
{
    public class CSharpWebApiBuilder : BaseBuilder<CSharpWebApiParameterModel>, ICSharpWebApiBuilder
    {
        #region Fields

        private static DateTime CreatedDateTime { get; set; }
        private static CSharpWebApiParameterModel Parameter { get; set; }

        #endregion

        #region PublicMethods

        public override void Initiate(CSharpWebApiParameterModel parameter)
        {
            Parameter = parameter;
