...
{
    public class SqlFunctionBuilder : BaseBuilder<SqlFunctionParameterModel>, ISqlFunctionBuilder
    {
        #region Fields

        private static DateTime CreatedDateTime { get; set; }
        private static SqlFunctionParameterModel Parameter { get; set; }

        #endregion

        #region PublicMethods

        public override void Initiate(SqlFunctionParameterModel parameter)
        {
            Parameter = parameter;
...
GO
/****** Object:  StoredProcedure {Parameter.FunctionName}    Script Date: {DateTime.Now} ******/
SET ANSI_NULLS ON
GO
...
------------------------------------------------------------------------------------------";
        ...
        {
            return $"ALTER PROCEDURE {Parameter.FunctionName}";
        }

        private static string BuildCreateProcedure()
        {
            return $"CREATE PROCEDURE {Parameter.FunctionName}";
        }
